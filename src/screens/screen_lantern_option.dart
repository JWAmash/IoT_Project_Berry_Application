...
class ScreenLanternOption extends StatefulWidget {
  const ScreenLanternOption({super.key});

  @override
  State<ScreenLanternOption> createState() => _ScreenLanternOptionState();
}

class _ScreenLanternOptionState extends State<ScreenLanternOption> {
  int sensorLowerLimit = 0;
  int sensorUpperLimit = 0;
  List<String> dropDownListCategory = ["켜짐", "꺼짐"];
  String selectedOperation1 = '켜짐';
  String selectedOperation2 = '꺼짐';
