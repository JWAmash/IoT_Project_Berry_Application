...
class ScreenLanternSchedule extends StatefulWidget {
  const ScreenLanternSchedule({super.key});

  @override
  State<ScreenLanternSchedule> createState() => _ScreenLanternScheduleState();
}

class _ScreenLanternScheduleState extends State<ScreenLanternSchedule> {
  final List<String> operation = ['켜짐', '꺼짐'];
  String? selectedOperation = '켜짐';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('조명 시간 설정',style: TextStyle(fontWeight: FontWeight.bold),),
      ),
      body: Stack(
        children: [
          Container(
